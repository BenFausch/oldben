...
<section class="full-width-container footer-full-width">
	<div class="container">
		<div class="container-fluid">
			<?php
			if( cyberchimps_get_option( 'footer_show_toggle' ) == '0' ) {
					...
					<div id="footer-widget-container" class="span12">
						<div class="row-fluid">
							...
							<?php if( !dynamic_sidebar( 'cyberchimps-footer-widgets' ) ) : ?>
								...
								<aside class="widget-container span3" style="font-size:30px;">
									<h3 class="widget-title" style="font-size:30px;"><?php _e( 'Categories', 'cyberchimps' ); ?></h3>
									<ul>
