/* Sunday 19th of January 2014 06:40:14 PM*/
...
(function($){ $(document).ready(function() {$(".nextend-hastip").qtip({
            ...
            ndojo.addOnLoad(function(){
                SmartSliderAdminSlide('nextend-smart-slider-0','6','slideslide', 'admin.php?page=nextend-smart-slider2&controller=layouts&action=create');
            });
